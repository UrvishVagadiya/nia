    ...
    <section id="updates" className="border-t border-line">
      <div className="section-container section-padding">
        ...
        >
          {updates.map((post) => {
            return (
              <StaggerItem key={post.id} direction="up" distance={25} className="flex">
                <Card className="bg-white rounded-[18px] border border-line ring-0 overflow-hidden flex flex-col shadow-none py-0! gap-0 group transition-all duration-300 hover:shadow-[0_12px_24px_-10px_rgba(14,58,92,0.06)] hover:-translate-y-1 w-full">
